...
plain URDF files or Mujoco MJCF files from within
[Python code](#python-library-usage) or via the
[command line](#command-line-usage). It is fully functional whether ROS is
